...
fold the belief as it stood at time *t* (CONVENTIONS.md: "As-of: belief at time t via edge-time filter +
...
(CONVENTIONS.md hard rule 6), and keeps `pnpm test` here fast and network-free.
