# Failure taxonomy — Errata arm, run `rerunF-wave`
...
| `B1_wrong_claim_picked` | 5 | 3.3 | answered wrong · a gold-supporting claim was in the material |
| `B2_extraction_gap` | 12 | 8.0 | answered wrong · no claim in the history supports the gold answer |
...
| `ok_answered` | 70 | 46.7 | answered and judged CORRECT |
| `ok_abstained` | 28 | 18.7 | abstained on a gold-abstention question |

Abstained-but-answerable: **29** of 120 answerable questions (24.2%). Answered-wrong: **21**. False answers on gold-abstention: **2** of 30.
...
| information_extraction | 38 | 16 | 5 | 17 |
| knowledge_update | 18 | 0 | 1 | 17 |
...
| question_type | n | errata | naive |
|---|---:|---:|---:|
| knowledge-update | 24 | 95.8% | 87.5% |
| multi-session | 43 | 67.4% | 47.3% |
| single-session-assistant | 14 | 7.1% | 92.9% |
| single-session-preference | 8 | 0.0% | 0.0% |
| single-session-user | 22 | 100.0% | 77.3% |
| temporal-reasoning | 39 | 59.0% | 33.3% |
...
- **71a3fd6b** (information_extraction)
  ...
  - gold: `+49 (0) 62 32 / 14 23 - 0`
  - errata: ABSTAINED (reason `synth_insufficient`)
  - matched tokens ['planning', 'speyer', 'phone', 'speyer', 'tourism', 'provided'] · unmatched ['trip', 'again', 'wanted', 'confirm', 'number', 'board', 'earlier']
  - 306 claims reachable / 452 in history; gold in material=False in graph=False
  - material head: ['trip_companions=brother', 'backpacking_trip_duration=one week', 'resource_list_item_1=Local Arts Council or Tourism Websites', 'planned_feed_label_review=review the current layer pellet label for calcium and other essential nutrients']
...
## `B1_wrong_claim_picked` — 5 (answered wrong · a gold-supporting claim was in the material)
...
- **a2f3aa27** (knowledge_update)
  - Q: How many followers do I have on Instagram now?
  - gold: `1300`
  - errata: `1250`
  - matched tokens ['now'] · unmatched ['many', 'followers', 'instagram']
  - 322 claims reachable / 467 in history; gold in material=True in graph=True
  - material head: ['watched_james_charles_videos_count=around 10 videos', 'car_floor_mat_replacement_cost=$120', 'loyalty_program=ShopRite Price Plus', 'tracked_loyalty_programs=CVS ExtraCare, Walgreens Balance Rewards, Target RedCard, and Fetch Rewards']

## `B2_extraction_gap` — 12 (answered wrong · no claim in the history supports the gold answer)
...
- **2788b940** (multi_session)
  ...
  - gold: `5`
  - errata: `4`
  - matched tokens ['fitness', 'classes'] · unmatched ['many', 'attend', 'typical', 'week']
  - 281 claims reachable / 477 in history; gold in material=False in graph=False
  - material head: ['fitness_classes=attends Zumba, Hip Hop Abs, yoga, and BodyPump classes', 'workout_classes=Zumba, Hip Hop Abs, yoga, and BodyPump', 'fitness_goals=has goals of increasing cardio endurance and improving strength', 'workout_goal=has fitness goals and wants healthy snacks to support them']
...
- **2e6d26dc** (multi_session)
  ...
  - gold: `5`
  - errata: `4`
  - matched tokens ['babies', 'born', 'friends', 'family', 'members', 'few', 'months'] · unmatched ['many', 'last']
  - 238 claims reachable / 416 in history; gold in material=False in graph=False
  - material head: ["attended_baby_shower=attended cousin Rachel's baby shower in February", 'cousin_baby=cousin Rachel had a baby boy named Max in March', 'fishing_companions=Alex and Ryan', 'fishing_catch=caught a large walleye last weekend with friends Alex and Ryan and grilled it on the shore']
- **38146c39** (information_extraction)
  ...
  - errata: `The material does not contain advice for chocolate chip cookies; it mentions a preference for a stronger, more intense frosting flavor to balance carrot cake spices.`
...
- **6e984301** (temporal)
  ...
  - gold: `3`
  - errata: `The material does not contain the information needed to answer.`
...
- **a3838d2b** (temporal)
  ...
  - gold: `4`
  - errata: `2`
  - matched tokens ['many', 'charity', 'events', 'run', 'cure', 'event'] · unmatched ['participate']
  - 309 claims reachable / 464 in history; gold in material=False in graph=False
  - material head: ['participated_in_event=the “Bike-a-Thon” charity event', 'attended_charity_golf_tournament=attended a charity golf tournament and played with colleagues', 'charity_golf_tournament_attendance_date=attended a charity golf tournament on July 17th', 'volunteered_at_event=Food for Thought charity gala']
...
- **6ae235be** (information_extraction)
  ...
  - errata: `The material does not specify which refining processes are used at the Lake Charles Refinery specifically; it only lists two different sets of general refining processes (atmospheric distillation, fluid catalytic cracking, alkylation, and hydrotreating; or atmospheric distillation, delayed coking, hydrocracking, and hydrotreating) and states that CITGO operates refineries in Lake Charles, Louisiana; Lemont, Illinois; and Corpus Christi, Texas.`
...
- **d851d5ba** (multi_session)
  ...
  - gold: `$3,750`
  - errata: `$2,750`
  - matched tokens ['charity'] · unmatched ['much', 'money', 'raise', 'total']
  - 314 claims reachable / 479 in history; gold in material=False in graph=False
  - material head: ['charity_fundraising_amount=$500', 'charity_fitness_challenge_completed=completed a charity fitness challenge', 'charity_fundraising_amount=$2,000', 'charity_fundraising_amount=raised $2,000 for a local animal shelter']
...
- **gpt4_7abb270c** (temporal)
  ...
  - errata: `Science Museum, Metropolitan Museum of Art, Modern Art Museum, Museum of History, Natural History Museum, Museum of Contemporary Art`
